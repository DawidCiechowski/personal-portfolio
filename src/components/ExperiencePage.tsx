...
const ExperiencePage: React.FC<ExpProps> = props => {
  return (
    <div className="pixel-corners tw-flex tw-w-5/6 tw-ml-16 tw-flex-col tw-pl-[3rem] tw-pr-[8rem] tw-py-[3rem] tw-bg-secondary tw-rounded-lg tw-min-h-[100px] tw-shadow-glow-sm tw-cursor-pointer hover:tw-shadow-glow-md tw-duration-300 hover:tw-scale-110">
      ...
      <p className="tw-text-[1.1rem] md:tw-text-[1.7rem] tw-text-slate-400 tw-font-medium tw-pt-[1rem]">
